...
-- Chance to sell drug
Config.ChanceSell = 80 -- (in %) 

-- Random sell amount if [Config.SellAnywhere == true]
Config.RandomSell = { min = 1, max = 10 } -- range: min, max
...
Config.SellItems = {
    { item = 'weed_white-widow', price = math.random(7, 13) },
    { item = 'weed_skunk', price = math.random(5, 11) },
    { item = 'weed_purple-haze', price = math.random(15, 31) },
    { item = 'weed_og-kush', price = math.random(13, 19) },
    { item = 'weed_amnesia', price = math.random(11, 17) },
    { item = 'weed_ak47', price = math.random(9, 15) },
    { item = 'coke_pooch', price = math.random(40, 55) },
}
